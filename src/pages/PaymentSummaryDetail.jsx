...
const PaymentSummaryDetail = () => {
  ...
  const loadSummary = async () => {
    try {
      ...
      const result = await getPaymentSummary_be(billId);
  ...
  const handleOpenMember = async (member) => {
    try {
      ...
      const result = await getPaymentMemberDetail(billId, member.Id);
  ...
  if (!summary) {
    return <div className="p-6">Payment summary not found</div>;
  }
                  ...
                  className={`w-full text-left
                                    ...
                                    ${
                                      isShort
                                        ...
                                        : "border-transparent hover:border-[#F8B500]"
                                    }
...
export default PaymentSummaryDetail;
